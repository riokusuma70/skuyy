globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery, createError } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/@prisma/client/index.js';
import Pusher from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/pusher/lib/pusher.js';
import { createRenderer } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/ufo/dist/index.mjs';
import destr from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/radix3/dist/index.mjs';
import chalk from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/chalk/source/index.js';
import { HtmlValidate, formatterFactory } from 'file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/html-validate/dist/es/index.js';
...
const serverAssets = [{"baseName":"server","dir":"D:/Internship/New folder/Invitation_Wedding/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Internship\\New folder\\Invitation_Wedding","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Internship\\New folder\\Invitation_Wedding\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Internship\\New folder\\Invitation_Wedding\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Internship\\New folder\\Invitation_Wedding\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _31lvdYLdAT = (function(nitro) {
...
const useChecker = (validator, usePrettier = false, logLevel = "verbose") => {
  ...
  const checkHTML = async (url, html) => {
    ...
    try {
      if (usePrettier) {
        const { format } = await import('file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/prettier/index.js');
    ...
    const formatter = couldFormat ? formatterFactory("codeframe") : await import('file://D:/Internship/New%20folder/Invitation_Wedding/node_modules/@html-validate/stylish/dist/index.js').then((r) => r.default?.default ?? r.default ?? r);
...
const _nWD4UyoDVP = (function(nitro) {
...
const _lazy_iA2Jm3 = () => Promise.resolve().then(function () { return wish_post$1; });
const _lazy_eHPLQz = () => Promise.resolve().then(function () { return wish_get$1; });
const _lazy_52srDP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/wish', handler: _lazy_iA2Jm3, lazy: true, middleware: false, method: "post" },
  { route: '/api/wish', handler: _lazy_eHPLQz, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_52srDP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_52srDP, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/Internship/New%20folder/Invitation_Wedding/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
